...
extern const Info<int> MAIN_MELEE_NETPLAY_TRANSPORT;
extern const Info<std::string> MAIN_MELEE_NETPLAY_EXTERNAL_TEST_TCP;
...
extern const Info<std::string> MAIN_MELEE_NETPLAY_REGION_TABLE;
...
extern const Info<std::string> MAIN_MELEE_NETPLAY_DIAG_WATCH;
extern const Info<bool> MAIN_MELEE_JUKEBOX;
extern const Info<int> MAIN_MELEE_JUKEBOX_VOLUME;
extern const Info<std::string> MAIN_MELEE_JUKEBOX_DEBUG_TRACK;
